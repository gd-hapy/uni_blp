...
var _SearchResults = _interopRequireDefault(__webpack_require__(/*! ./pages/SearchResults/SearchResults.vue */ 127));
// @ts-ignore
...
/* harmony import */ var _SearchResults_vue_vue_type_template_id_576a6964___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./SearchResults.vue?vue&type=template&id=576a6964& */ 128);
/* harmony import */ var _SearchResults_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./SearchResults.vue?vue&type=script&lang=js& */ 130);
...
/* harmony import */ var _SearchResults_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./SearchResults.vue?vue&type=style&index=0&lang=scss& */ 132);
  ...
  if (!_vm._isMounted) {
    _vm.e0 = function (item) {
      ...
      var _temp = args[args.length - 1].currentTarget.dataset,
        ...
        item = _temp2.item
      var _temp, _temp2
      return _vm.itemHandleClick(item)
    }
  }
...
var _url = __webpack_require__(/*! @/src/config/url */ 65);
...
var _default = {
  ...
  methods: {
    requestList: function requestList() {
      ...
      (0, _uniRequest.request)((0, _url.url_searchResults_url)(this.searchKeyWord), 'POST').then(function (res) {
